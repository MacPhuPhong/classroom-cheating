...
frame_total = 2000
i = 0
a = 11277 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'D:\git&github\classroom-cheating\images1'
...
while cap.isOpened():
    ...
    pa = r'D:\git&github\classroom-cheating\images'
...
csv_file_path = r'D:\git&github\classroom-cheating\nkeypoint.csv'
